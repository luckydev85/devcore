...
export default {
  ...
  watch: {
    advancedForm( newValue ) {
      console.log( newValue )
      if( newValue.issueEvaluationRoles.length || 
          newValue.issueTemplateRoles.length || 
          newValue.shareAccessRoles.length ) {
        this.form.useAdvanced = true;
      }
    }
  },
  async mounted() {
